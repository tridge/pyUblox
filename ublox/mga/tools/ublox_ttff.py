...
#        self.dev.configure_poll_port(ublox.PORT_USB)
    ...
    def get_fix(self, mga_dbd_source_dev=None, mga_offline_cache_file=None, position=None, reset=False, send_time=False):
...
#                        print("msg: %s" % (str(msg),))
    ...
    def run(self):
        ...
        parser.add_option("--reset", help="reset module time", action="store_true")
        parser.add_option("--time", help="Set module time", action="store_true")
